...
import ru.marten.votingforrestaurants.util.UsersUtil;
...
import static ru.marten.votingforrestaurants.web.user.ProfileController.REST_URL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(repository.findAll(), admin, guest, newUser);
    }
